...
pub fn combobox_page() -> Html {
    ...
    let props = vec![
        PropDoc { name: "value", prop_type: "Option<String>", default: "-", description: "Controlled selected value" },
        PropDoc { name: "on_value_change", prop_type: "Callback<String>", default: "-", description: "Value change handler" },
